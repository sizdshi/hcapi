-- 充值活动表
create table if not exists hcapi.recharge_activity
(
...
-- 商品订单
create table if not exists hcapi.product_order
(
    id             bigint auto_increment comment 'id' primary key,
...
#付款信息
create table if not exists hcapi.payment_info
(
    id             bigint auto_increment comment 'id' primary key,
    orderNo        varchar(256)                           null comment '商户订单号',
...
-- 用户接口调用表
create table if not exists hcapi.user_interface_invoke
(
    id           bigint auto_increment comment 'id' primary key,
...
INSERT INTO hcapi.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime,
...
INSERT INTO hcapi.interface_info
VALUES ('1705234447153963010', '随机毒鸡汤', 'https://gateway.qimuu.icu/api/poisonousChickenSoup',
        '1698354419367571457', 'GET', null, '1', 'https://gateway.qimuu.icu/api/poisonousChickenSoup', null, null,
        '随机毒鸡汤', '1', '1', null, 'JSON',
...
INSERT INTO hcapi.interface_info
VALUES ('1705237104270712833', '获取输入的名称', 'https://gateway.qimuu.icu/api/name', '1698354419367571457', 'GET',
        '[{\"id\":\"1695031845159\",\"fieldName\":\"name\",\"type\":\"string\",\"desc\":\"输入的名称\",\"required\":\"是\"}]',
        '1', 'https://gateway.qimuu.icu/api/name?name=zhangshan', null, null, '获取输入的名称', '2', '0',
...
INSERT INTO hcapi.interface_info
VALUES ('1705237990061580289', '随机壁纸', 'https://gateway.qimuu.icu/api/randomWallpaper', '1698354419367571457',
        'GET',
        ...
        '1', 'https://gateway.qimuu.icu/api/randomWallpaper?lx=dongman', null, null, '获取随机壁纸', '1', '1',
...
INSERT INTO hcapi.interface_info
VALUES ('1705238841173942274', '每日星座运势', 'https://gateway.qimuu.icu/api/horoscope', '1698354419367571457', 'GET',
        ...
        '1', 'https://gateway.qimuu.icu/api/horoscope?type=scorpio&time=nextday', null, null, '获取每日星座运势', '1',
        '3', 'https://img.qimuu.icu/interface_avatar/1698354419367571457/r2X9jsoT-horoscope2.png', 'JSON',
...
INSERT INTO hcapi.interface_info
VALUES ('1705239469589733378', '随机土味情话', 'https://gateway.qimuu.icu/api/loveTalk', '1698354419367571457', 'GET',
        null, '1', 'https://gateway.qimuu.icu/api/loveTalk', null, null, '获取土味情话', '1', '0',
...
INSERT INTO hcapi.interface_info
VALUES ('1705239928861827073', '获取IP信息归属地', 'https://gateway.qimuu.icu/api/ipInfo', '1698354419367571457', 'GET',
        '[{\"id\":\"1695388304868\",\"fieldName\":\"ip\",\"type\":\"string\",\"desc\":\"输入IP地址\",\"required\":\"否\"}]',
        '1', 'https://gateway.qimuu.icu/api/ipInfo?ip=58.154.0.0', null, null, '获取IP信息归属地详细版', '1', '9',
...
INSERT INTO hcapi.interface_info
VALUES ('1705240565347459073', '获取天气信息', 'https://gateway.qimuu.icu/api/weather', '1698354419367571457', 'GET',
        ...
        '1', 'https://gateway.qimuu.icu/api/weather?ip=180.149.130.16', null, null, '获取每日每周的天气信息', '1', '1',
